...
function iniciaJogo(){
	...
	function pontuacao(acao){
		...
		baloes_estourdos = parseInt(baloes_estourados);
	...
	function remove_eventos_baloes(){
		...
		/*percorrer os elementos de acordo com o id e só irá sair do laço quando não houver 
		correspondencia com o elemento*/
